...
def _render_lab2(review: Lab2Review, revision: str) -> str:
    ...
    return (
        ...
        + _render_contract_cards(review.contract, review.observed_result)
        + "<section class='evidence-section'><div class='section-title'>"
        "<h3>Fanout Algorithm Map · CURRENT</h3><span>确定性编排，不是共享 Memory 的 Main Agent</span></div>"
        ...
        "</div></section>"
        "<section class='evidence-section'><div class='section-title'>"
        "<h3>Future Extension</h3><span>FUTURE / NOT IMPLEMENTED</span></div>"
        "<div class='answer-strip'>"
        "<div><b>Planner Agent</b><span>natural-language decomposition → typed FanoutPlan</span></div>"
        "<div><b>Conflict Resolver Agent</b><span>semantic repair after a blocked candidate conflict</span></div>"
        "</div></section>"
        "<section class='evidence-section'><div class='section-title'>"
