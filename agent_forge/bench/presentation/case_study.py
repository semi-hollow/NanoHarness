...
def render_case_study(result: BenchCaseResult) -> str:
    ...
    lines = [
        ...
        f"- source: `{result.diagnosis_source or 'not_recorded'}`",
        f"- rule: `{result.diagnosis_rule_id or 'not_recorded'}`",
        f"- taxonomy_version: `{result.diagnosis_taxonomy_version or 'not_recorded'}`",
