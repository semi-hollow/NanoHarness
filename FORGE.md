...
- `docs/架构导览.md` 拥有五段系统主链；`docs/上下文工程.md`、`docs/工具治理与执行.md` 和
  `docs/运行产物与持久化契约.md` 分别拥有对应机制语义；`docs/核心能力与代码入口.md`
  拥有能力到首个 Owner 的映射；`agent_forge/README.md` 只提供 package 代码地图。
