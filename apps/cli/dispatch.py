...
from agent_forge.memory.api import (
    forget_memory,
    list_memories,
    RememberMemoryRequest,
    remember_memory,
)
from apps.cli.inspection import print_skills, render_inspection, render_doctor
from apps.cli.parser import build_parser
from apps.repository_run import run_repository_task
from apps.cli.resume import resume_repository_task
...
from apps.workbench.api import run_ui_from_args
...
def main(argv: list[str] | None = None) -> None:
    ...
    if args.command == "console":
        from apps.operator_console import run_console_from_args
